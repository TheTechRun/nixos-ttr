...
$b $s+k $e alacritty
$b $s+Shift+k $e terminator -l scratchterm #opens up in scratchpad
...
$b $s+$a+3 $e bash $HOME/.config/i3-layout-manager/layout_manager.sh #layout creater and loader
...
#$b $s+F6 $e bash $HOME/.config/i3-layout-manager/layout_manager.sh CFDAILY
...
$b $s+w $e jumpapp chromium
for_window [class="Chromium"] move to workspace 1; workspace 1; focus
for_window [class="firefox"] move to workspace 1; workspace 1; focus
...
# WORKSPACE 4 - ferdium
for_window [class="Ferdium"] move to workspace 4; workspace 4; focus
for_window [class="Claude"] move to workspace 4; workspace 4; focus


# WORKSPACE 5 - joplin
#for_window [class="Joplin"] move to workspace 5; workspace 5
for_window [class="libreoffice-calc"] move to workspace 5; workspace 5; focus


# WORKSPACE 6 - messaging
assign [class="Element"] $ws6 # Element
assign [class="TelegramDesktop"] $ws6 # Telegram
assign [class="discord"] $ws6 # Discord


# WORKSPACE 7 - obs & kdenlive
for_window [class="obs"] move to workspace 7; workspace 7; focus
for_window [class="kdenlive"] move to workspace 7; workspace number 7; focus

# Workspace 8 - vmm & kdenlive project monitor
for_window [class="Virt-manager"] move to workspace 8; workspace 8; focus
for_window [title="Project Monitor"] move to workspace 8; workspace 8; focus

# WORKSPACE 9 - youtube & vlc
for_window [class="vlc"] move to workspace 9; workspace 9; focus
$b $s+y $e firefox https://www.youtube.com/
for_window [title="(?i)youtube"] move to workspace 9; workspace 9; focus

# WORKSPACE 0 - Scrap Paper
for_window [class="Terminator"][title="SSH-TERMINAL"] move to workspace 0; workspace 0; focus
for_window [class="Terminator"][title="ARCH-TERMINAL"] move to workspace 0; workspace 0; focus
for_window [class="xdman-Main"] move to workspace 0; workspace 0; focus
for_window [title="Virtual Machine Manager"] move to workspace 0; workspace 0; focus
...
# WINDOW RULES
#---------------------------------------------------------------------
for_window [instance="gpick" class="Gpick"] floating enable, move position center, resize set 1200 600 px
...
# for_window [class="com.sayonara-player.Sayonara"] move window to scratchpad, move position center, resize set 1600 1000 px
#$b $s+m [class="com.sayonara-player.Sayonara"] scratchpad show, move position center, resize set 1600 1000 px 
for_window [class="Clementine"] move window to scratchpad, move position center, resize set 1600 1000 px
$b $s+m [class="Clementine"] scratchpad show, move position center, resize set 1600 1000 px 
...
for_window [class=".catfish-wrapped"] move window to scratchpad, move position center, resize set 1600 1000 px
$b $s+shift+s [class=".catfish-wrapped"] scratchpad show, move position center, resize set 1600 1000 px 
for_window [title="SCRATCHTERM"] move window to scratchpad, move position center, resize set 1600 1000 px
$b Menu [title="SCRATCHTERM"] scratchpad show, move position center, resize set 1600 1000 px
bindcode 105 [title="SCRATCHTERM"] scratchpad show, move position center, resize set 1600 1000 px
...
for_window [title="Resources"] move window to scratchpad, move position center, resize set 1600 1000 px
$b Control+$a+Delete [title="Resources"] scratchpad show, move position center, resize set 1600 1000 px 
for_window [title="keycheat.png"] move window to scratchpad, move position center, resize set 1600 1000 px
...
for_window [title="mousecheat.png"] move window to scratchpad, move position center
bindcode $s+117 [title="mousecheat.png"] scratchpad show, move position center, resize set 1600 1000 px 

# MORE STARTUP SCRIPTS:
exec_always --no-startup-id  $HOME/.screenlayout/laptop.sh # monitors layouts
